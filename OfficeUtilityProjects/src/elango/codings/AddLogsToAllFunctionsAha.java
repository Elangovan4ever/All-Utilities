...
public class AddLogsToAllFunctionsAha {
	public static int firstFuncLineNum = 0;

	public static void main(String[] args) {
		//File currentDir = new File("C:\\Users\\emanickam\\Documents\\Code\\src"); 
		File currentDir = new File("D:\\AhaConnect\\workspace\\src"); 
		
		processFiles(currentDir);
	}

	public static void processFiles(File dir) {
			String[] filesToAddHeadersArr = {"ImageStore.cpp","MaseratiHMIController.cpp","Session.cpp","StationContentSelectionState.cpp"
						,"SvcIpcSignalListener.cpp","SubaruHMIController.cpp","AhaJSONUtils.cpp","Event.cpp"
						,"AhaServiceIPCMessage.cpp","ContentImage.cpp"};
	...
	public static void updateFile(File file)
	{
		try
		{
			...
			while ((line = fReader.readLine()) != null) {
				...
				&& !line.contains("if(") && !line.contains("while(") && !line.contains("for(") && !line.contains("switch(") 
				&& !line.contains("~") && !line.contains("#define") && !line.contains("catch") && !line.contains("handleBinaryImageData") 
				&& !line.contains("PerformAction::handleResponse") && !line.contains("getInstance()->registerForSignal")
				)
				{
					firstFuncLineNum = (firstFuncLineNum == 0)?lineno:firstFuncLineNum;
