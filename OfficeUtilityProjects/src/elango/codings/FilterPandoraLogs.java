...
public class FilterPandoraLogs {
	...
	private static String keysToFindPandoraProcess[] = {
		...
		"PndrUpdateStationActive", "pndrEventTrackPlay", "PndrUpdateTrackElapsed" };
	
	private static HashMap<String, String > threadInfo = new HashMap<String, String>(){{
        put("1","Main_thread");
        put("2","Trace_thread");
        put("3","Dbus_thread");
        put("4","ReadMsgQueueThread");
        put("5","SigQueueThread");
        put("6","ReadThread");
        put("7","TimerThread");
	...
	public static void main(String[] args) {
	    ...
	    for (int i = 0; i < listOfFiles.length; i++) 
	    {
			...
			else if (listOfFiles[i].isFile()) 
			{
				...
				String processId = "";
				processId = getProcessId(fileLines, keysToFindPandoraProcess);
				if (processId == "NONE") {
					log("No pandora processId found");
					return;
				}
				
				log("Pandora processId found, processId = " + processId);
				filterPandoraLogs(listOfFiles[i].getName(), fileLines, processId);
			}	 
	    }
	}
	...
	public static void filterPandoraLogs(String fileName, Vector<String> fileLines, String processId) {
		try {
	...
	public static String getProjectDirectory() {
		String projectDir = "D:\\";
		try {
			URL u = FilterPandoraLogs.class.getProtectionDomain().getCodeSource()
					.getLocation();
	...
	public static void initializeLogger() {
		...
		LOGFILENAME = projectDir + "\\log\\"
				+ FilterPandoraLogs.class.getSimpleName() + ".log";
