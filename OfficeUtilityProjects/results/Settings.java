...
;
    ...
    void createNewUserLILPw(PackageManagerService service, Installer installer,
        ...
        //<BEGIN> GM Info 3.0 security enhancement <wenji.lu@gm.com>
        //path.mkdir(); //mkdir will be done inside of encryptfsMkdir method
        gm.pm.PackageSettingUtils.ecryptfsMkdir(userHandle, path);
        //<END>
