...
#Region " Private Methods "
    ...
    Private Sub DrawTabContent(ByVal graphics As Graphics, ByVal id As Integer)
        ...
        ''Dim contentRect As Rectangle = New Rectangle(0, 0, tabRect.Width, tabRect.Height)
        ...
        Dim bkColor As Color = If(id = SelectedIndex, Color.White, Me.BackColor)
